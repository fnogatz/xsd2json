...
var parseStringOpts = {
	tagNameProcessors: [
		...
		function(name) {
			if (/:schema|:sequence|:complexType|:simpleType|:include|:import|:complexContent|:extension|:all|:element|:attribute|:simpleContent|:any|:choice|:annotation|:group|:annotation|:union/.test(name)) {
